...
setup_pkg() {
    ...
    export CFLAGS="$XBPS_CFLAGS $XBPS_CROSS_CFLAGS $CFLAGS $dbgflags -O3"
    export CXXFLAGS="$XBPS_CXXFLAGS $XBPS_CROSS_CXXFLAGS $CXXFLAGS $dbgflags -O3"
    export FFLAGS="$XBPS_FFLAGS $XBPS_CROSS_FFLAGS $FFLAGS $dbgflags"
    export CPPFLAGS="$XBPS_CPPFLAGS $XBPS_CROSS_CPPFLAGS $CPPFLAGS -O3"
    export LDFLAGS="$XBPS_LDFLAGS $XBPS_CROSS_LDFLAGS $LDFLAGS -O3"
    export LTOFLAGS="-flto=full"
    export BUILD_CC="clang"
    export BUILD_CXX="clang++"
    export BUILD_CPP="clang++"
    ...
    export CPP_FOR_BUILD="clang++"
    export FC_FOR_BUILD="gfortran"
    export LD_FOR_BUILD="ld.lld"
	...
	export FFLAGS_host="$XBPS_FFLAGS"
        ...
        export CFLAGS="$XBPS_TARGET_CFLAGS $CFLAGS -O3"
        export CXXFLAGS="$XBPS_TARGET_CXXFLAGS $CXXFLAGS -O3"
        export FFLAGS="$XBPS_TARGET_FFLAGS $FFLAGS"
        export CPPFLAGS="$XBPS_TARGET_CPPFLAGS $CPPFLAGS -O3"
        export LDFLAGS="$XBPS_TARGET_LDFLAGS $LDFLAGS -O3"
	export LTOFLAGS="-flto=full"
        # Tools
        export CC="clang"
        export CXX="clang++"
